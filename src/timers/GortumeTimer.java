    ...
    public void run() {
        if (this.gm.isGortume()) {
            ...
            if (this.gm.getGortumeTimer() != -1) {
                if (gortumeTimer != 0 || gortumeTimer != 10 || gortumeTimer != 9 || gortumeTimer != 8 || gortumeTimer != 7 || gortumeTimer != 6 || gortumeTimer != 5 || gortumeTimer != 4
                        || gortumeTimer != 3 || gortumeTimer != 2 || gortumeTimer != 1) {
                    gortumeTimer--;
